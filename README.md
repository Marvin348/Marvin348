...
For the past 14 months I’ve been learning and building projects with **HTML**, **CSS**, **TypeScript**, **Tailwind** and **React** and I recently started diving into backend **(Node + Express)** to strengthen m foundation.
